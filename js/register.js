...
$('document').ready(function() {
    ...
    $('#iniciar-sesion').on('click', function() {
        ...
        if (usuarioValidado.existe) {
            ...
            sessionStorage.setItem("data", JSON.stringify(data)); //Guarda la info del profesor ingresando a un sessionStorage // JSON.stringify para convertir json en strings
            document.location.href = '/localhost/linguaProject/Profesor.html';
        } else {
